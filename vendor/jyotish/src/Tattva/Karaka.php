...
class Karaka
{
     ...
     * Own self
     */
    const NAME_ATMA = 'Атмакарака';
    /**
     * Advisor
     */
    const NAME_AMATYA = 'Аматйакарка';
    /**
     * Brothers and sisters
     */
    const NAME_BHRATRU = 'Бхратрукарака';
    /**
     * Mother
     */
    const NAME_MATRU = 'Матрукарака';
    /**
     * Father
     */
    const NAME_PITRU = 'Питрукарака';
    /**
     * Children
     */
    const NAME_PUTRA = 'Путракарака';
    /**
     * Cousins and relations
     */
    const NAME_GNATI = 'Гнатикарака';
    /**
     * Husband, wife
     */
    const NAME_DARA = 'Даракарака';
    /**
     * Death
     */
    const NAME_AYUSH = 'Аюшкарака';
