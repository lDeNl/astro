    ...
    private function formatParams(array $input, array $params = null)
    {
        ...
        if (is_null($params) || in_array(Data::BLOCK_GRAHA, $params)) {
            ...
            $dataParams['graha'][Graha::KEY_KE] = [
                ...
                'latitude'    => !empty($dataParams['graha'][Graha::KEY_RA]['latitude']) ? $dataParams['graha'][Graha::KEY_RA]['latitude'] : false,
                'speed'       => !empty( $dataParams['graha'][Graha::KEY_RA]['speed']) ?  $dataParams['graha'][Graha::KEY_RA]['speed'] : false,
                'rashi'       => $units['units'],
                'degree'      => $units['parts'],
